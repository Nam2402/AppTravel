...
public class LoveLocationAdapter  extends RecyclerView.Adapter<LoveLocationAdapter.ItemLocationHolder> {
    private List<BaseLocation> baseLocationArrayList;
    private Context mContext;


    public LoveLocationAdapter(List<BaseLocation> baseLocationArrayList, Context mContext) {
    ...
    public ItemLocationHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.rc_item_love_location, null);
